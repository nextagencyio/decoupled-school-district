...
export const metadata: Metadata = {
  title: 'Contact Us',
  description: 'Get in touch with Oakridge School District. Contact us for enrollment information, school tours, or questions about our programs and services.',
  keywords: ['Contact School District', 'Enrollment', 'School Information', 'Get in Touch'],
}
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-8 md:mb-12">
            ...
            <p className="text-base md:text-lg text-gray-600">
              Have questions about our schools or programs? We&#39;d love to hear from you.
            </p>
          </div>
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">info@oakridgeschools.edu</p>
                    <p className="text-gray-600">support@oakridgeschools.edu</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">(555) 456-7829</p>
