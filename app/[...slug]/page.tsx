  ...
  return (
    <div className="text-center py-16">
      <div className="bg-white border border-gray-200 rounded-lg p-12">
        <div className="h-1 bg-primary-600 -mt-12 -mx-12 mb-8 rounded-t-lg" />
          ...
          <ErrorBoundary>
            <article className="bg-white border border-gray-200 rounded-lg overflow-hidden">
              ...
              <div className="p-6 md:p-8">
                <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-display font-bold text-gray-900 mb-4 md:mb-6">{title}</h1>
