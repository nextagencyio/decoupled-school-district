...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  if (!item) {
    return { title: 'Program Not Found | School District' }
  }
            ...
            <div className="lg:col-span-1">
              <div className="bg-white rounded-xl shadow-sm p-6 sticky top-24">
                ...
                <dl className="space-y-4">
                  ...
                  {(item as any).gradesServed && (
                    <div>
                      <dt className="text-sm text-gray-500">Grades Served</dt>
                      <dd className="font-semibold text-gray-900">{(item as any).gradesServed}</dd>
                    </div>
                  )}
                </dl>
                <div className="mt-8">
